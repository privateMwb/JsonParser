...
// clang-format off
#include <JsonPro/Json.h>          // core type under test — not directly used by this tool's own
#include <JsonPro/JsonException.h> // code today; keep only if the main file needs it, otherwise drop
