...
static void copy_constructor_deep_array() {
...
static void copy_constructor_deep_object() {
    Json::ObjectType obj;
...
static void copy_nested_structure_independent() {
    Json::ObjectType obj;
...
static void run_tests() {
    RUN(copy_constructor_deep_array);
    RUN(copy_constructor_deep_object);
    RUN(copy_assignment);
    RUN(self_copy_assignment_unchanged);
    RUN(copy_nested_structure_independent);
}
